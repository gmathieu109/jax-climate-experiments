...
def main():
    ...
    def loss_fn(param_dict):
        ...
        alpha_alb = info["alpha_alb"]

        reg_l2 = args.lambda_l2 * jnp.mean((alpha_alb - 1.0) ** 2)
        reg_smooth = args.lambda_smooth * spatial_smoothness(alpha_alb)
