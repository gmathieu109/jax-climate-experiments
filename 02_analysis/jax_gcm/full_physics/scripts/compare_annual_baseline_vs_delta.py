...
ERA5_FIELD = "/cuyo/gmathieu/eval_cache/era5_T850_daily_on_jcm_grid.nc"

BASELINE_NC = "/cuyo/gmathieu/outputs_uqam/jcm_experiments/full_1y_no_spinup/run_nc/jcm_full_1y.nc"
OPT_NC = "/cuyo/gmathieu/optimized_10y/sst_masked_jan15d_sm0p02_1y/run_nc/jcm_sst_masked_jan15d_sm0p02_1y.nc"

OUTDIR = Path("/cuyo/gmathieu/optimized_10y/sst_masked_jan15d_sm0p02_1y/comparison_figures")
...
era5 = xr.open_dataarray(ERA5_FIELD).sel(time=slice("2000-01-01", "2000-12-30"))
...
fig.savefig(OUTDIR / "mean_bias_maps_baseline_vs_delta.png", dpi=300, bbox_inches="tight")
plt.close(fig)

print("Saved:")
print(OUTDIR / "timeseries_global_mean_T850_baseline_vs_delta.png")
print(OUTDIR / "mean_bias_maps_baseline_vs_delta.png")
